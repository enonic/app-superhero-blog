...
exports.testInitRunsSynchronouslyWhenProjectMissing = function () {
    t.assertEquals(1, calls.initComments, 'initComments should be called once');
    ...
    t.assertEquals('sample-blog', calls.createdId, 'created project id');
